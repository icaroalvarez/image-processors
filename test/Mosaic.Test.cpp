...
{
    cv::Mat image = cv::imread(fixtures_path"Lenna.png");
    cv::Mat roi_bottom_right = cv::imread(fixtures_path"Lenna_bottom_right.png");
    cv::Mat roi_bottom_left = cv::imread(fixtures_path"Lenna_bottom_left.png");
    cv::Mat roi_top_right = cv::imread(fixtures_path"Lenna_top_right.png");
    cv::Mat roi_top_left = cv::imread(fixtures_path"Lenna_top_left.png");
    ...
    SECTION("Reuse mosaic by resetting it")
    {
        ...
        mosaic.addImage(roi_top_left, 0, 0);
        mosaic.addImage(roi_top_right, 1, 0);
        cv::Mat lenna_top = cv::imread(fixtures_path"Lenna_top.png");
